...
go install github.com/mozmark/OneCRL-Tools/oneCRL2RevocationsTxt &>/tmp/oneCRL2RevocationsTxt-install.out
if [ $? -ne 0 ]
then
	echo " fail"
	echo "FAIL: go install github.com/mozmark/OneCRL-Tools/oneCRL2RevocationsTxt"
